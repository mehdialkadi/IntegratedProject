...
const LoginFormProprietaire = ({ onLoginSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post('/api/proprietaires/findProprioByEmailAndPassword', { email, password })
            .then(response => {
...
export default LoginFormProprietaire;
